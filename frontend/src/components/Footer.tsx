        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <Link to="/" className="text-2xl font-black gradient-text hover:opacity-90 transition-opacity">
                  Aletheia
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/model" className="text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                  Our Model
                </Link>
              </li>
              <li>
                <Link to="/intervention" className="text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                  The Intervention
                </Link>
              </li>
              <li>
                <Link to="/safety-net" className="text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                  Safety Net
                </Link>
              </li>
              <li>
                <Link to="/team" className="text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                  Our Team
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/impact" className="text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                  Research Papers
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/contact" className="text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-600 dark:text-slate-400 text-sm">
              © {currentYear} The Aletheia Project. All rights reserved.
            </p>
